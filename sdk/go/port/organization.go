...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("port:index/organization:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("port:index/organization:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
